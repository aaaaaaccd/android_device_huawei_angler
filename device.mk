...
PRODUCT_COPY_FILES += \
    device/huawei/angler/nfc/libnfc-brcm.conf:$(TARGET_COPY_OUT_VENDOR)/etc/libnfc-brcm.conf \
...
# For SPN display
PRODUCT_COPY_FILES += \
    device/huawei/angler/spn-conf.xml:$(TARGET_COPY_OUT_VENDOR)/etc/spn-conf.xml
...
# old-apns.conf
PRODUCT_COPY_FILES += \
    device/huawei/angler/old-apns-conf.xml:$(TARGET_COPY_OUT_VENDOR)/etc/old-apns-conf.xml
